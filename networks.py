...
# model = VT_full_resnet_generator()
...
def stylegan_discriminator_adapted():

    '''
    Adaptado do discriminador utilizado nos papers ProgGAN e styleGAN
    1ª adaptação é para poder usar a mesma loss e estrutura do discriminador anterior
    ...
    x = tf.keras.layers.Conv2D(16, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 16, 256, 256)
    x = tf.keras.layers.LeakyReLU()(x)
    x = tf.keras.layers.Conv2D(16, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 16, 256, 256)
    x = tf.keras.layers.LeakyReLU()(x)
    x = tf.keras.layers.Conv2D(32, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 32, 256, 256)
    x = tf.keras.layers.LeakyReLU()(x)
    
    # Etapa 256 (convoluções 6 e 7)
    x = tf.keras.layers.Conv2D(64, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 64, 256, 256)
    x = tf.keras.layers.LeakyReLU()(x)
    x = tf.keras.layers.Conv2D(128, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 128, 256, 256)
    x = tf.keras.layers.LeakyReLU()(x)
    x = simple_downsample(x, scale = 2) # (bs, 128, 128, 128)
    
    # Etapa 128
    x = tf.keras.layers.Conv2D(128, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 128, 128, 128)
    x = tf.keras.layers.LeakyReLU()(x)
    x = tf.keras.layers.Conv2D(256, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 256, 128, 128)
    x = tf.keras.layers.LeakyReLU()(x)
    x = simple_downsample(x, scale = 2) # (bs, 256, 64, 64)
    
    # Etapa 64
    x = tf.keras.layers.Conv2D(256, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 256, 64, 64)
    x = tf.keras.layers.LeakyReLU()(x)
    x = tf.keras.layers.Conv2D(512, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 512, 64, 64)
    x = tf.keras.layers.LeakyReLU()(x)
    x = simple_downsample(x, scale = 2) # (bs, 512, 32, 32)
    
    # Etapa 32 
    x = tf.keras.layers.Conv2D(512, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 512, 32, 32)
    x = tf.keras.layers.LeakyReLU()(x)
    x = tf.keras.layers.Conv2D(512, (1 , 1), strides=1, kernel_initializer=initializer)(x) # (bs, 512, 32, 32)
    x = tf.keras.layers.LeakyReLU()(x)
